...
SOUND_SENSOR_AVERAGE_SAMPLES=10
...
soundSensorProxy = SensorProxy(soundSensor,SOUND_SENSOR_REFRESH_PERIOD,SOUND_SENSOR_PRECISION,SOUND_SENSOR_AVERAGE_SAMPLES)
